...
\begin{frame}{Experimental Setup}
  ...
  \end{itemize}
  \begin{highlightbox}{Honesty check}
    This is a \alert{single training seed} per algorithm. The SRLP
    guidelines call for multiple seeds with confidence intervals — not yet
    run; see \textit{Limitations} below.
  \end{highlightbox}
\end{frame}
