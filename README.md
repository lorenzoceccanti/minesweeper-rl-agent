...
The aim of this project consist in training an agent to play Minesweeper game, in a customized MDP environment and evaluate the performances of DQN and PPO algorithms.
